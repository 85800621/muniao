...
public class Room {
    ...
    private Integer house_type;           // 房源类型（民居、客栈）
    private String title;                 // 房源标题
    private Integer price_interval_id;    // 价格区间
    private Integer room_feature_id;      // 房间特色id（别墅、主题房）
    private Integer user_id;              // 房源所属用户id
    private String city;                  // 城市
    private String lng;                   // 经度
    private String lat;                   // 纬度
    private String province;              // 省份
    private Double price;                 // 价格
    private Integer rent_type;            // 出租类型（整租、单间）
    private Integer isaddbed;             // 是否可以加床
    private Integer refund_type;          // 协议类型（严格 灵活）
    ...
    public Integer getPrice_interval_id() {
        return price_interval_id;
    }

    public void setPrice_interval_id(Integer price_interval_id) {
        this.price_interval_id = price_interval_id;
    }

    public Integer getRoom_feature_id() {
        return room_feature_id;
    }

    public void setRoom_feature_id(Integer room_feature_id) {
    ...
    public RoomPriceInterval getPriceInterval() {
        return priceInterval;
    }

    public void setPriceInterval(RoomPriceInterval priceInterval) {
