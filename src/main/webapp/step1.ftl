...
<head>
    ...
    <script type="text/javascript" src="${staticRoot}/images/apiadd"></script>
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/getscript?v=2.0&ak=B8b89fc728345142f220bad603de3515&services=&t=20180529182003"></script>
    <script type="text/javascript">
        ...
        function setHaiwaiCity() {
            ...
            $("#div_Asia_A").html(Asia_A);
            $("#div_Asia_H").html(Asia_H);
            $("#div_Asia_L").html(Asia_L);
            $("#div_Asia_T").html(Asia_T);
            $("#div_Europe_A").html(Europe_A);
            $("#div_Europe_H").html(Europe_H);
            $("#div_Europe_L").html(Europe_L);
            $("#div_Europe_T").html(Europe_T);
            $("#div_America_A").html(America_A);
            $("#div_America_H").html(America_H);
            $("#div_America_L").html(America_L);
            $("#div_America_T").html(America_T);
            $("#div_Oceania_A").html(Oceania_A);
            $("#div_Oceania_H").html(Oceania_H);
            $("#div_Oceania_L").html(Oceania_L);
            $("#div_Oceania_T").html(Oceania_T);
            $("#div_Africa_A").html(Africa_A);
            $("#div_Africa_H").html(Africa_H);
            $("#div_Africa_L").html(Africa_L);
            $("#div_Africa_T").html(Africa_T);
        }
    ...
    <script type="text/javascript" charset="UTF-8" src="${staticRoot}/images/common.js.下载"></script>
    <script type="text/javascript" charset="UTF-8" src="${staticRoot}/images/util.js.下载"></script>
    <script type="text/javascript" charset="UTF-8" src="${staticRoot}/images/stats.js.下载"></script>
    <script type="text/javascript" charset="UTF-8" src="${staticRoot}/images/AuthenticationService.Authenticate"></script>
</head>
<body style="">
    ...
    <div class="r-content">
        ...
        <div class="r-address clear">
            <div class="r-country r-d-select">
                ...
                <input id="contry" class="r-input" type="text" value="中国" readonly="readonly"
                       onclick="$(&#39;#contry_list&#39;).show();">
            ...
            <div id="div_province1" class="r-province r-d-select">
                <p>省份/直辖市/自治区</p>
                <input id="ipt_ProvinceName" autocomplete="off" class="province-input" type="text" readonly="readonly"
                       placeholder="-请选择-" onclick="$(&#39;#div_sheng&#39;).show();">
            ...
            <div id="div_city1" class="r-city r-d-select">
                ...
                <input id="ipt_CityName" autocomplete="off" class="r-input" type="text" readonly="readonly"
                       placeholder="-请选择-" onclick="$(&#39;#div_prov_city&#39;).show();">
                <div id="div_prov_city" class="city-s r-input-list link-select"
                     style="max-height:300px; overflow-y:auto;"></div>
            </div>
            <div id="div_city2" class="r-city r-d-select" style="display:none;">
                <p>海外城市</p>
                <input id="ipt_CityEn" class="r-input_haiwai" type="text" readonly="readonly" placeholder="-请选择-"
                       onclick="$(&#39;#div_haiwai_city&#39;).show();">
            ...
            <div id="div_area1" class="r-region r-d-select">
                ...
                <input id="ipt_AreaName" autocomplete="off" class="r-input" type="text" name="region"
                       readonly="readonly" placeholder="-请选择-" onclick="$(&#39;#div_city_area&#39;).show();">
                <div id="div_city_area" class="region-s r-input-list link-select"
                     style="max-height:300px; overflow-y:auto;"></div>
            </div>
        </div>
        ...
        <div class="publish-address-street">
            ...
            <div class="addressInput-box">
                <input id="ipt_AddressStreet" type="text" name="region-name" maxlength="40"
                       placeholder="请详细填写您的房源地址，精确到路名，如万源路28号"
                       onkeyup="$(&#39;.t-jiedao&#39;).html(this.value); cstyle(0,this.value.length,40);">
                <span class="text-num"><span id="ready0" class="ready-num">0</span>/<span
                        class="total-num">40</span></span>
            </div>
        </div>
        <div class="address-otherInput">
            ...
            <div class="otherInput-box clear">
                ...
                <input id="ipt_AddressXiaoqu" autocomplete="off" type="text" name="floor-num" maxlength="20"
                       placeholder="如梅源里小区"
                       onkeyup="$(&#39;.t-xiaoqu&#39;).html(this.value); cstyle(1, this.value.length, 20);">
                <span class="text-num"><span id="ready1" class="ready-num">0</span>/<span
                        class="total-num">20</span></span>
            </div>
            <div class="otherInput-box clear">
                <span class="input-title">楼号</span>
                <input id="ipt_AddressBuild" autocomplete="off" type="text" name="floor" maxlength="10"
                       placeholder="如8号楼"
                       onkeyup="$(&#39;.t-louhao&#39;).html(this.value); cstyle(2, this.value.length, 10);">
                <span class="text-num"><span id="ready2" class="ready-num">0</span>/<span
                        class="total-num">10</span></span>
            </div>
            <div class="otherInput-box clear">
                <span class="input-title">单元号</span>
                <input id="ipt_AddressUnit" autocomplete="off" type="text" name="floor-num2" maxlength="10"
                       placeholder="如2单元"
                       onkeyup="$(&#39;.t-danyuan&#39;).html(this.value); cstyle(3, this.value.length, 10);">
                <span class="text-num"><span id="ready3" class="ready-num">0</span>/<span
                        class="total-num">10</span></span>
            </div>
            <div class="otherInput-box clear">
                <span class="input-title">门牌号</span>
                <input id="ipt_AddressDoor" autocomplete="off" type="text" name="floor-num1" maxlength="10"
                       placeholder="如502室"
                       onkeyup="$(&#39;.t-menpai&#39;).html(this.value); cstyle(4, this.value.length, 10);">
                <span class="text-num"><span id="ready4" class="ready-num">0</span>/<span
                        class="total-num">10</span></span>
            </div>
        </div>
        <div class="r-map">
            ...
            <div id="allmap" title="点击定位"
                ...
                <div style="overflow: visible; position: absolute; z-index: 0; left: 0px; top: 0px; cursor: url(&quot;http://api0.map.bdimg.com/images/openhand.cur&quot;) 8 8, default;">
                    <div class="BMap_mask"
                         style="position: absolute; left: 0px; top: 0px; z-index: 9; overflow: hidden; user-select: none; width: 760px; height: 300px;"></div>
                    <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 200;">
                        ...
                        <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 700;">
                            ...
                            padding: 0px; margin: 0px; border: 0px; cursor: pointer; background: url(&quot;http://api0.map.bdimg.com/images/blank.gif&quot;);
                            width: 22px; height: 75px; left: 369px; top: 113px; z-index: -7979488;" title=""></span>
                        </div>
                        ...
                        <div style="position: absolute; height: 0px; width: 0px; left: 0px; top: 0px; z-index: 400;">
                            <span class="BMap_Marker" unselectable="on"
                                  style="position: absolute; padding: 0px; margin: 0px; border: 0px; width: 0px; height: 0px; left: 369px; top: 113px; z-index: -7979488;"><div
                                    style="position: absolute; margin: 0px; padding: 0px; width: 22px; height: 75px; overflow: hidden;"><img
                                    src="${staticRoot}/images/spotlight-poi.png"
                                    style="display: block; border:none;margin-left:0px; margin-top:0px; "></div><label
                                    class="BMapLabel" unselectable="on"
                                    style="position: absolute; display: inline; cursor: inherit; background-color: rgb(255, 255, 255); border: 1px solid gray; padding: 5px; white-space: nowrap; font-style: normal; font-variant: normal; font-weight: normal; font-stretch: normal; font-size: 12px; line-height: normal; font-family: arial, sans-serif; z-index: 80; color: black; width: 110px; user-select: none; left: 20px; top: -20px;">请拖动到您房源位置</label></span>
                        </div>
                    ...
                    <div style="position: absolute; overflow: visible; top: 0px; left: 0px; z-index: 1;">
                        <div style="position: absolute; overflow: visible; z-index: -100; left: 380px; top: 150px; display: block; transform: translate3d(0px, 0px, 0px);">
                            <img src="${staticRoot}/images/saved_resource"
                                 style="position: absolute; border: none; width: 256px; height: 256px; left: -154px; top: -102px; max-width: none; opacity: 1;"><img
                                src="${staticRoot}/images/saved_resource(1)"
                                style="position: absolute; border: none; width: 256px; height: 256px; left: -410px; top: -102px; max-width: none; opacity: 1;"><img
                                src="${staticRoot}/images/saved_resource(2)"
                                style="position: absolute; border: none; width: 256px; height: 256px; left: 102px; top: -102px; max-width: none; opacity: 1;"><img
                                src="${staticRoot}/images/saved_resource(3)"
                                style="position: absolute; border: none; width: 256px; height: 256px; left: -154px; top: -358px; max-width: none; opacity: 1;"><img
                                src="${staticRoot}/images/saved_resource(4)"
                                style="position: absolute; border: none; width: 256px; height: 256px; left: 358px; top: -102px; max-width: none; opacity: 1;"><img
                                src="${staticRoot}/images/saved_resource(5)"
                                style="position: absolute; border: none; width: 256px; height: 256px; left: -410px; top: -358px; max-width: none; opacity: 1;"><img
                                src="${staticRoot}/images/saved_resource(6)"
                                style="position: absolute; border: none; width: 256px; height: 256px; left: 102px; top: -358px; max-width: none; opacity: 1;"><img
                                src="${staticRoot}/images/saved_resource(7)"
                                style="position: absolute; border: none; width: 256px; height: 256px; left: 358px; top: -358px; max-width: none; opacity: 1;">
                        </div>
                    </div>
                ...
                <div unselectable="on" class=" BMap_stdMpCtrl BMap_stdMpType0 BMap_noprint anchorTL"
                    ...
                    <div class="BMap_stdMpZoom" style="height: 147px; width: 62px;">
                        ...
                        <div class="BMap_stdMpSlider" style="height: 108px;">
                            ...
                            <div class="BMap_stdMpSliderBgBot" style="top: 55px; height: 57px;"></div>
                            <div class="BMap_stdMpSliderMask" title="放置到此级别"></div>
                            <div class="BMap_stdMpSliderBar" title="拖动缩放"
                                 style="cursor: url(&quot;http://api0.map.bdimg.com/images/openhand.cur&quot;) 8 8, default; top: 55px;">
                                <div class="BMap_smcbg"></div>
                            </div>
                        </div>
                        <div class="BMap_zlHolder hvr">
                            <div class="BMap_zlSt">
                                <div class="BMap_smcbg"></div>
                            </div>
            ...
            <script type="text/javascript">
                ...
                function createMark(center) {
                    ...
                    $("#ipt_Lat").val(center.lat);
                    //创建自定义标记
                    var myIcon = new BMap.Icon("${staticRoot}/images/spotlight-poi.png", new BMap.Size(22, 75));
            ...
            <script>
                ...
                function initMap(objid) {
                    try {
                        ...
                        //设置标记
                        var image = '${staticRoot}/images/spotlight-poi.png';
            ...
            <script src="${staticRoot}/images/js" async="" defer=""></script>
            <!--map end-->
        </div>
        ...
        <div class="s_mn_security">
            <ul class="s_mn_security_list">
                ...
                <li><a href="http://webscan.360.cn/index/checkwebsite/url/muniao.com" rel="nofollow" title="安全检测"
                       target="_blank"><img src="${staticRoot}/images/pic6.jpg" alt="安全检测" title="安全检测" width="109"
                                            height="50"></a></li>
            </ul>
        </div>
    </div>
