...
<!-- saved from url=(0044)http://user2.muniao.com/UserInfo/Index?utp=1 -->
...
<!--href="http://user2.muniao.com/UserInfo/Index?utp=1#close" style="display: none;"><em-->
...
<!--href="http://user2.muniao.com/UserInfo/Index?utp=1#"><img width="50"-->
<!--height="50"-->
<!--defaultsrc=""-->
...
<!--href="http://user2.muniao.com/UserInfo/Index?utp=1#show"><strong-->
...
<div class="newa_login_main">
    ...
    <div class="newa_login_con">
        ...
        <p class="newa_zc">还没有木鸟账号？<a href="http://user2.muniao.com/regist">立即注册</a></p>
        <div class="newa_coop">
            <a class="newa_sina" href="http://user2.muniao.com/UserInfo/Index?utp=1#"></a>
            <a class="newa_qq" href="http://user2.muniao.com/UserInfo/Index?utp=1#"></a>
        </div>
    </div>
    <!---tips--->
    ...
    <div class="userL" style="box-shadow: 4px 2px 10px rgba(0, 0, 0, 0.25);margin-bottom: 30px;">
        ...
        <div class="usidebar">
            ...
            <ul>
                ...
                <li id="li2" class="usidebarlibg"><img src="${staticRoot}/images/application_view_icons.gif" width="18"
                ...
                <li id="li20" class="usidebarlibg"><img src="${staticRoot}/images/shanding.png" width="18" height="18"
                                                        align="absmiddle"><a
                        href="http://user2.muniao.com/Room/Flashset?utp=1">闪订管理</a><img
                        src="${staticRoot}/images/icon_newAdd.png" align="absmiddle"></li>
            </ul>
            ...
            <ul>
                ...
                <li id="li13" class="usidebarlibg1"><img src="${staticRoot}/images/user_edit.gif" width="18" height="18"
                                                         align="absmiddle"><a
                        href="http://localhost/muniao/lodgerinfo">个人信息</a></li>
                ...
                <li id="li15" class="usidebarlibg"><img src="${staticRoot}/images/comment_reply.gif" width="18" height="18"
                                                        align="absmiddle"><a
                        href="http://user2.muniao.com/SystemMsg/Index?date=131731601138467927">消息提醒</a></li>
            </ul>
        </div>
    </div>
    <!--欢迎页面开始-->
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td height="30" align="left" valign="middle" class="uinfotd">
                            <div id="div_Tel">
                                <div id="Tel_M" class="fLeft mL5" style="font-weight:bolder;">18792074922</div>
                            ...
                            <div id="div_Tel1" style="display:none;">
                                <input id="edit_Tel" type="text" class="uinfoinput"
                                       ...
                                       value="18792074922" maxlength="11">
                    ...
                    <tr>
                        ...
                        <td width="655" height="40" align="left" valign="middle" class="uinfotd">
                            <span id="BirthDay"
                                  style="float:left; padding-left:5px; font-weight:bolder;">1997-04-10</span>&nbsp;
                    ...
                    <tr>
                        ...
                        <td width="655" height="30" align="left" valign="middle" class="uinfotd">
                            ...
                            <select id="Province" onchange="getCityList(this.value)">
                                ...
                                <option value="12" selected="selected">安徽</option>
                            ...
                            <select id="City" onchange="$(&#39;msg_City&#39;).hide();">
                                ...
                                <option value="115">安庆</option>
                                <option value="116">蚌埠</option>
                                <option value="117">亳州</option>
                                <option value="118">巢湖</option>
                                <option value="119">池州</option>
                                <option value="120">滁州</option>
                                <option value="121">阜阳</option>
                                <option value="122">合肥</option>
                                <option value="123">淮北</option>
                                <option value="124">淮南</option>
                                <option value="125">黄山</option>
                                <option value="126" selected="selected">六安</option>
                                <option value="127">马鞍山</option>
                                <option value="128">宿州</option>
                                <option value="129">铜陵</option>
                                <option value="130">芜湖</option>
                                <option value="131">宣城</option>
                            </select>
                    ...
                    <tr>
                        ...
                        <td width="655" height="30" align="left" valign="middle" class="uinfotd">
                            <input id="Profession" type="text" class="uinfoinput" value="java开发工程师" maxlength="15">
                        </td>
                    </tr>
                    <tr>
                        <td width="100" height="30" align="right" valign="middle" bgcolor="#f5f5f5" class="uinfotd">
                        ...
                        <td width="655" height="30" align="left" valign="middle" class="uinfotd">
                            ...
                            <input id="School" type="text" class="uinfoinput" maxlength="25">
                        </td>
                    </tr>
                    <tr>
                        <td height="30" align="right" valign="middle" bgcolor="#f5f5f5" class="uinfotd">电子邮箱：</td>
                        <td height="30" align="left" valign="middle" class="uinfotd">
                            <input id="Email" type="text" class="uinfoinput" value="1101838066@qq.com"
                    ...
                    <tr style="">
                        ...
                        <td height="30" align="left" valign="middle" class="uinfotd">
                            <input id="Tel" type="text" class="uinfoinput" value="18792074922">
                    ...
                    <tr>
                        ...
                        <td height="30" align="left" valign="middle" class="uinfotd">
                            <input id="QQ" type="text" class="uinfoinput" value="1101838066"
                    ...
                    <tr style="">
                        ...
                        <td height="30" align="left" valign="middle" class="uinfotd">
                            <input id="WeChat" type="text" class="uinfoinput" value="gzt6288">
                        </td>
                    </tr>
                    <tr>
                        <td width="100" height="40" align="right" valign="middle" bgcolor="#f5f5f5" class="uinfotd">
                            ...
                            <div style="float:left;">
                                <div>
                                    <textarea id="Profile" class="uinfotextarea"
                                              ...
                                              onchange="$(&#39;#msg_Profile&#39;).hide();">没啥特点。</textarea>
                            ...
                            <div style="float:left;">
                                <div>
                                    ...
                                    <div id="fileList" class="uploader-list" style="float:left;padding:5px;">
                                        <div id="WU_FILE_a" class="file-item thumbnail upload-state-done"
                                             style="float:left; margin:3px;">
                                            <img style="border:solid 1px #eee; padding:1px;width:100px;height:100px;"
                                                 src="${staticRoot}/images/d590d8e4b87c4c65922d653c3812d4a620180604093556672.jpg"
                                                 fullurl="http://assets.muniao.com/UploadFiles/image/20180604/d590d8e4b87c4c65922d653c3812d4a620180604093556672.jpg"
                                                 url="UploadFiles/image/20180604/d590d8e4b87c4c65922d653c3812d4a620180604093556672.jpg">
                                            <div class="info">
                                                <dele style="cursor:pointer;line-height:15px;" title="点击删除"
                                                      onclick="$(&#39;#WU_FILE_a&#39;).remove();">删除
                                                </dele>
                                            </div>
                                        </div>
                                    ...
                                    <div id="filePicker" style="float:left;margin-top:15px;margin-left:-5px;"
                                        ...
                                        <div id="rt_rt_1cfmd23ng1hfq171d2eknk9pr81"
