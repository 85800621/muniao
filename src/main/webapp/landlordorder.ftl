...
<!-- saved from url=(0041)http://user2.muniao.com/Order/Index?utp=1 -->
...
<!--href="http://user2.muniao.com/Order/Index?utp=1#close" style="display: none;"><em-->
...
<!--href="http://user2.muniao.com/Order/Index?utp=1#"><img width="50"-->
<!--height="50"-->
<!--defaultsrc=""-->
...
<!--href="http://user2.muniao.com/Order/Index?utp=1#show"><strong-->
...
<div class="newa_login_main">
    ...
    <div class="newa_login_con">
        ...
        <p class="newa_zc">还没有木鸟账号？<a href="http://user2.muniao.com/regist">立即注册</a></p>
        <div class="newa_coop">
            <a class="newa_sina" href="http://user2.muniao.com/Order/Index?utp=1#"></a>
            <a class="newa_qq" href="http://user2.muniao.com/Order/Index?utp=1#"></a>
        </div>
    </div>
    <!---tips--->
        ...
        <div class="usidebar">
            ...
            <ul>
                ...
                <li id="li15" class="usidebarlibg"><img src="${staticRoot}/images/comment_reply.gif" width="18" height="18"
                                                        align="absmiddle"><a
                        href="http://user2.muniao.com/SystemMsg/Index?date=131729106455972938">消息提醒</a></li>
            </ul>
        </div>
    </div>
    <!--欢迎页面开始-->
        ...
        <div class="myorder">
            <div class="userR">
                <div class="myordercon">
                    <ul>
                        <li><a href="http://user2.muniao.com/Order/Index?act=order&amp;type=8&amp;utp=1">全部订单</a></li>
                        <li><a href="http://user2.muniao.com/Order/Index?act=order&amp;type=1&amp;utp=1">已付款</a></li>
                        <li><a href="http://user2.muniao.com/Order/Index?act=order&amp;type=6&amp;utp=1">待入住</a></li>
                        <li><a href="http://user2.muniao.com/Order/Index?act=order&amp;type=2&amp;utp=1">未付款</a></li>
                        <li><a href="http://user2.muniao.com/Order/Index?act=order&amp;type=3&amp;utp=1">退款</a></li>
                        <!--<li><a href="?act=order&type=4">收取订金</a></li>-->
                        <li><a href="http://user2.muniao.com/Order/Index?act=order&amp;type=7&amp;utp=1">等待确认</a></li>
                        <li><a href="http://user2.muniao.com/Order/Index?act=order&amp;type=5&amp;utp=1">取消订单</a></li>
                        <div class="clear"></div>
                    </ul>
                    ...
                    $(function () {
                        $("#demo1").jqPaginator({
                            ...
                            onPageChange: function (n) {
                                if (key) location.href = '/Order/index?rows=5&utp=1&page=' + n;
                                if (!key) key = true;
                            }
                        });
                    })            </script>
            ...
            <div class="w_usersqtkbox" style="display: none; top: 475px;">
            ...
            <div id="cal_dialog" class="cal_dialog noeve display"
                 style="position: absolute; top: 783.5px; left: 560px; width: 320px; height: auto; display: none;">
